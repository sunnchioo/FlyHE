...
vector<vector<int>> COEFF_MODULI =
    {
        ...
        {58, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 58},  // LayerNorm (3)  29 levels
...
int main() {
    ...
    */
    if (TEST_TARGET == "GELU") {
        ...
        ifstream input_file("/mnt/data2/home/syt/data/fhec/boot/data/input/gelu_input_32768.txt");
        while (input_file >> num) {
            input.push_back(num);
        }
        input_file.close();

        ifstream calibration_file("/mnt/data2/home/syt/data/fhec/boot/data/calibration/gelu_calibration_32768.txt");
        while (calibration_file >> num) {
    ...
    */
    if (TEST_TARGET == "LayerNorm") {
        ...
        ifstream input_file("/mnt/data2/home/syt/data/Libra/RLWE/boot/data/input/layernorm_input_16_768.txt");
        while (input_file >> num) {
            input.push_back(num);
        }
        input_file.close();

        ifstream calibration_file("/mnt/data2/home/syt/data/Libra/RLWE/boot/data/calibration/layernorm_calibration_16_768.txt");
        while (calibration_file >> num) {
